...
Максимальна напруга на обкладках конденсатора ідеального коливального контуру досягає 2.0 кВ. Яким є період електромагнітних коливань у контурі, якщо за амплітудного значення сили струму 1.0 А енергія магнітного поля в контурі становить 1.0 мДж?

**Завдання 3 (0.833 мкс та 88 пФ)**:
...
1. Діючі значення сили струму й напруги; **(В-дь: 0.354 А та 318.6 В)**
2. потужність, яка виділяється на ділянці; **(В-дь: 112.5 Вт)**
3. напругу, на яку має бути розрахована ізоляція проводів; **(В-дь: 450 В)**
4. запишіть рівняння залежності змінної напруги $u(t)$. **(В-дь: 450sin(100πt)(В))**
