...
3.  **Пластична деформація (відо точки В до точки С)**
...
4.  **Ділянка зміцнення (від точки D до точки E):**
...
5.  **Ділянка руйнування (від точки E до точки K):**
...
Або:
$$ \Delta V = V_0 b \Delta t $$

Де:
*   $\Delta V$ - зміна об'єму (м³).
*   $V_0$ - початковий об'єм тіла при початковій температурі (м³).
*   $\Delta t$ - зміна температури (°C або К).
*   $b$ - **коефіцієнт об'ємного теплового розширення**.

> **Коефіцієнт об'ємного теплового розширення** ($b$) - це фізична величина, що показує, на яку частину свого початкового об'єму збільшується тіло при нагріванні на 1°C (або 1 К). Це також характеристика матеріалу.

Одиницею вимірювання $b$ в системі СІ є **обернений Кельвін (К⁻¹)** або **обернений градус Цельсія (°C⁻¹)**.

### Зв'язок між коефіцієнтами лінійного та об'ємного розширення

Для ізотропних твердих тіл (тобто тих, чиї властивості однакові в усіх напрямках, як ми обговорювали на попередній сторінці, згадуючи полікристали та аморфні тіла) існує простий зв'язок між коефіцієнтом лінійного розширення $\alpha$ та коефіцієнтом об'ємного розширення $b$.
